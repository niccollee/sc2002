...
switch(level_no) {
    ...
    public void approveRejectInternship(CompanyRep commpanyRep, Scanner sc){
        ...
        boolean successfulDecide = companyRep.acceptStudentInternship(student, internship, decision);
        if (successfulDecide && decision) System.out.println("Application accepted successfully");
        else if (successfulDecide && !decision) System.out.println("Application rejected successfully");
